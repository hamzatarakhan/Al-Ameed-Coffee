...
const dict = {
  ...
  orderStatus: {
    title: { ar: 'تتبع الطلب', en: 'Track Order' },
    placedTitle: { ar: 'تم إرسال طلبك!', en: 'Order sent!' },
    received: { ar: 'تم استلام الطلب', en: 'Order received' },
    preparing: { ar: 'قيد التحضير', en: 'Preparing' },
    readyPickup: { ar: 'جاهز للاستلام', en: 'Ready for pickup' },
    readyDelivery: { ar: 'بالطريق إليك', en: 'Out for delivery' },
    completedPickup: { ar: 'تم الاستلام', en: 'Picked up' },
    completedDelivery: { ar: 'تم التوصيل', en: 'Delivered' },
    etaPickup: { ar: 'خلال 15-20 دقيقة', en: 'in 15-20 minutes' },
    etaDelivery: { ar: 'خلال 30-45 دقيقة', en: 'in 30-45 minutes' },
    advance: { ar: 'تحديث الحالة (تجريبي)', en: 'Advance status (demo)' },
    viewOrder: { ar: 'تتبع الطلب', en: 'Track your order' },
